(function () {
    ...
    angular.module('app.files').controller('filesCtrl', [ '$scope', 'filesServices', 'filterFilter', '$rootScope', 'logger', '$filter', filesCtrl]);
        
    function filesCtrl($scope, filesServices, filterFilter, $rootScope, logger, $filter) {
        var init;
