(function () {
    ...
    angular.module('app.files').controller('filesDetailsCtrl', [ '$scope', 'filesServices', 'filterFilter', '$rootScope', 'logger', '$filter', filesDetailsCtrl]);
        
    function filesDetailsCtrl($scope, filesServices, filterFilter, $rootScope, logger, $filter) {
        var init;
